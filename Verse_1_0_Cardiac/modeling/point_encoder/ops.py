...
class DistMaps(nn.Module):
    ...
    def get_coord_features(self, points, batchsize, rows, cols):
        if self.cpu_mode:
            ...
            # [batch_size , 2 * max_num_points,3]
            points = points.view(-1, points.size(2))
            # torch.Size([984, 3]) flat
            points, points_order = torch.split(points, [2, 1], dim=1)
            # spilt to location and avaibility [984, 2], and [984,1]
            ...
            # coords size: torch.Size([984, 2, 240, 240])
